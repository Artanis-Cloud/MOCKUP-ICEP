<div>
        ...
        <div class="add-input">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control bg-light @error('room_type') is-invalid @enderror"
                            wire:model="room_type.{{ $value }}" name="room_type"  placeholder="Room Type">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Room Size</label>
                        <input type="text" class="form-control bg-light @error('size') is-invalid @enderror"
                            wire:model="size.{{ $value }}" name="size"  placeholder="Size">
                        @error('size.' . $value)
                        <div class="alert alert-danger">
                            <strong>{{ $message }}</strong>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Type Of Bed</label>
                        <input type="text" class="form-control bg-light @error('type_of_bed') is-invalid @enderror"
                            wire:model="type_of_bed.{{ $value }}"  name="type_of_bed" placeholder="">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>View</label>
                        <input type="text" class="form-control bg-light @error('view') is-invalid @enderror"
                            wire:model="view.{{ $value }}" name="view"  placeholder="">
                        @error('view.' . $value)
                        <<div class="alert alert-danger">
                            <strong>{{ $message }}</strong>
                    </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label>Single Rate (1 Breakfast)</label>
                    <input type="text" class="form-control bg-light @error('single_rate') is-invalid @enderror"
                        wire:model="single_rate.{{ $value }}" name="single_rate"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label>Double Rate (2 Breakfast)</label>
                    <input type="text" class="form-control bg-light @error('double_rate') is-invalid @enderror"
                        wire:model="double_rate.{{ $value }}" name="double_rate"
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label>Corporate Rate</label>
                    <input type="text" class="form-control bg-light @error('corporate_rate') is-invalid @enderror"
                        wire:model="corporate_rate.{{ $value }}" name="corporate_rate"
    ...
    <div class="col-md-12" style="padding-top: 1%">
        ...
        <button type="submit" onclick="return confirm('Confirm Submit?')" class="m-auto btn btn-primary btn-outline-primary badge-pill btn-block w-75">Submit Rooms</button>
