                                    ...
                                    @endforelse
                                        ...
                                        <div class="border-0 rounded-lg card" style="padding: 5%">
                                         ...
                                         <ul class="mb-3 nav nav-pills" id="pills-tab" role="tablist" style="background-color: #2F4858; justify-content: space-evenly;">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false"><font color="white">All Rooms Available</font></a>
                                            </li>
                                            <li class="nav-item">
                                    ...
                                    <table class="table text-dark table-borderless">
                                        <thead>
                                            <tr class="text-center">
                                                <th><p class="mb-0">Room Types</p></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="text-center">
                                                <td><p class="mb-0 font-weight-bold">{{ $datahotel->room_type }}</p></td>
