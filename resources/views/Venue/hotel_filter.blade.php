                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="size" id="" class="form-control bg-light">
                                                ...
                                                <option value="500"
                                                    {{ $sizeselected == '500' ? 'selected="selected"' : '' }}class="">
                                                    0-500
                                                </option>
                                                <option value="1000"
                                                    {{ $sizeselected == '1000' ? 'selected="selected"' : '' }}class="">
                                                    501-1000
                                                </option>
                                                <option value="1500"
                                                    {{ $sizeselected == '1500' ? 'selected="selected"' : '' }}class="">
                                                    1001-1500
                                                </option>
                                                <option value="2000"
                                                    {{ $sizeselected == '2000' ? 'selected="selected"' : '' }}class="">
                                                    1501-2000
                                                </option>
                                                <option value="2001"
                                                    {{ $sizeselected == '2001' ? 'selected="selected"' : '' }}class="">
                                                    2001 and
                                                    above</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="single" id="" class="form-control bg-light">
                                                ...
                                                <option value="500"
                                                    {{ $singlerateselected == '500' ? 'selected="selected"' : '' }}
                                                    class="">0-500</option>
                                                <option value="1000"
                                                    {{ $singlerateselected == '1000' ? 'selected="selected"' : '' }}
                                                    class="">501-1000</option>
                                                <option value="1500"
                                                    {{ $singlerateselected == '1500' ? 'selected="selected"' : '' }}
                                                    class="">1001-1500</option>
                                                <option value="2000"
                                                    {{ $singlerateselected == '2000' ? 'selected="selected"' : '' }}
                                                    class="">1501-2000</option>
                                                <option value="2001"
                                                    {{ $singlerateselected == '2001' ? 'selected="selected"' : '' }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15935.17731018773!2d101.69481858588372!3d3.148893338671856!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc37d12d669c1f%3A0x9e3afdd17c8a9056!2sPETRONAS%20Twin%20Towers!5e0!3m2!1sen!2smy!4v1618928630135!5m2!1sen!2smy"
                                        ...
                                        <center>
                                            <div class="card" style="width: 18rem;">
                                                <img class="card-img-top"
                                                    src="{{ asset($image_path = str_replace('public', 'storage', $data->thumbnail)) }}"
                                                    alt="Card image cap" style="width:100%;height:200px;padding-top:5%;">
                                                <div class="card-body">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p>Radius from KLCC (walking distance): {{ $data->walking_radius }}
                                                    </p>
                                                    <p>Room Type</p>
                                                            ...
                                                            @forelse ($rooms as $dataRoom)
                                                                @if ($data->id == $dataRoom->hotel_id)
                                                                    <option value="{{ $dataRoom->id }}">
                                                                        {{ $dataRoom->room_type }}</option>
                                                                @endif
                                                            @empty
                                                                <option selected="true" disabled="disabled" value="0">No
                                                                    Room Available</option>
                                                            @endforelse
