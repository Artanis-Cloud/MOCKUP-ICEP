                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('room_detail') }}" class="" method="POST">
                                                @csrf
                                                <select name="room_id" class="form-control bg-light @error('room_id') is-invalid @enderror"">
                                                    <option selected=" true" disabled="disabled" hidden value="">Choose Room Type</option>
