                  ...
                  <div class="card" style="padding: 10px;">
                    ...
                    <div style="padding: 5px;"></div>
                      ...
                      <div class="p-0 card-body">
                        ...
                        <form class="" action="{{route('admin.audit-trail.audit-trail-log.filter')}}" method="post">
                            @csrf
                          <div class="row">
                            <div class="col-md-1">
                            ...
                            <div class="col-md-3">
                              ...
                              <button type="submit" class="m-auto btn btn-primary" name="button"><i class="fa fa-search" aria-hidden="true"></i> Tapis Senarai</button>
                              <a href="{{ route('admin.audit-trail.audit-trail-log') }}" class="m-auto btn btn-primary"><i class="fa fa-refresh" aria-hidden="true"></i> Reset</a>
                            </div>
                          </div>
                        </form>
                        <br>
